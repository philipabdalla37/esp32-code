...
static inline void setup_i2s(i2s_port_t port, int sck, int ws, int sd) {
  i2s_config_t cfg = {
...
void setup() {
  ...
  setup_i2s(I2S_PORT0, I2S0_SCK, I2S0_WS, I2S0_SD);
  setup_i2s(I2S_PORT1, I2S1_SCK, I2S1_WS, I2S1_SD);
}
